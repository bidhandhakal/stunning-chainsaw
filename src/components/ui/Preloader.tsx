...
const Preloader = () => {
  ...
  return (
    <div className="fixed inset-0 z-[6] flex" ref={preloaderRef}>
      ...
      <p className="name-text flex text-[20vw] lg:text-[200px] font-[font6] text-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 leading-none overflow-hidden text-white">
