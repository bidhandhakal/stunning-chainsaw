...
const DecayCard: React.FC<DecayCardProps> = ({
  width = 300,
  height = 400,
  image = "https://github.com/bidhandhakal.png",
  children,
}) => {
  ...
  useEffect(() => {
    // Initialize values that depend on window
    cursor.current = {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-[0.5em] left-[1.7em] tracking-[-0.5px] font-black text-[2rem] leading-[1.5em] first-line:text-[2rem]">
        {children}
      </div>
    </div>
  );
